const messages = {
  'zh-CN': {
    ...
    guide: {
      kicker: '快速导航',
      title: '第一次使用，按这 4 步走就够了',
      subtitle: '这个插件把网站价格、积分包、模型消耗拆开录入，再自动换算成统一币种的单次成本。',
      visualSite: '网站',
      visualPlan: '套餐',
      visualModel: '模型',
      visualResult: '对比',
      step1Title: '先录网站和套餐',
      step1Body: '把平台名称、默认币种、套餐价格和积分数量保存下来。直接标价的平台可以跳过套餐。',
      step2Title: '再录模型',
      step2Body: '模型只需要名称和类型。类型会决定后面显示 token、图片、视频或音频单位。',
      step3Title: '填写模型价格',
      step3Body: '选择网站和模型，按网页上的计费方式填写积分消耗或直接单价。',
      step4Title: '生成对比表',
      step4Body: '在对比设置里选择网站和模型，系统会按汇率和使用量算出可比较的成本。',
      startQuickEntry: '开始快速录入',
      managePlatforms: '录入网站',
      openComparison: '去生成对比表',
    },
    ruleList: {
      filterPlatform: '按网站筛选',
      filterModel: '按模型筛选',
      allPlatforms: '全部网站',
      allModels: '全部模型',
      pageSize: '每页显示',
    ...
    forms: {
      ...
      cycle: '周期',
      credits: '积分数量',
      exchangeRate: '汇率（相对结果币种）',
      exchangeRateHint: '此汇率为静态参考值，非实时获取。如需精确换算，请手动调整。',
      savePlan: '保存套餐',
      updatePlan: '更新套餐',
